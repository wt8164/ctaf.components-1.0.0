...
import { AgEditorComponent } from './ag.editor.component';
...
@Injectable()
export class AgComponentFactory extends AgBaseComponentFactory {
    ...
    public createComponent<T>(componentType: { new (...args: any[]): T; },
        ...
        if (!factory) {
            ...
            factory = moduleWithFactories.componentFactories.find((f: ComponentFactory<T>) => f.componentType === componentType);
