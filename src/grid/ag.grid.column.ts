...
@Component({
    selector: 'ctaf-cp-gridcolumn',
    template: ''
})
export class AgGridColumnComponent {
    @ContentChildren(AgGridColumnComponent) public childColumns: QueryList<AgGridColumnComponent>;
    ...
    private getChildColDefs(childColumns: QueryList<AgGridColumnComponent>) {
        return childColumns
            // necessary because of https://github.com/angular/angular/issues/10098
    ...
    private createColDefFromGridColumn(from: AgGridColumnComponent): ColDef {
        let colDef: ColDef = {};
