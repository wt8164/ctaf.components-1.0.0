import { NgModule, Component, ElementRef, AfterViewInit, OnDestroy, OnInit, Input, Output, SimpleChange
    , EventEmitter, forwardRef, Renderer, trigger, state, style, transition, animate, ViewChild, ChangeDetectorRef } from '@angular/core';
...
const CALENDAR_VALUE: any = {
    provide: NG_VALUE_ACCESSOR,
    /* tslint:disable */useExisting: forwardRef(() => TimePickerComponent),
    multi: true
};
...
@CTAFComponent({
    ...
    providers: [DomHandler, CALENDAR_VALUE]
})

export class TimePickerComponent extends DatetimeComponent {
    ...
    constructor(public el: ElementRef, public domHandler: DomHandler, public renderer: Renderer, cdr: ChangeDetectorRef) {
        super(el, domHandler, renderer, cdr);
    }
