...
@Component({
  /* tslint:disable */selector: 'node-menu',
  ...
  private availableMenuItems: NodeMenuItem[] = [
    {
      ...
      cssClass: 'new-tag fa fa-file-o'
    },
    {
      name: 'New folder',
      action: NodeMenuItemAction.NewFolder,
      cssClass: 'new-folder fa fa-folder-o',
    },
    {
      name: 'Rename',
      action: NodeMenuItemAction.Rename,
      cssClass: 'rename fa fa-pencil'
    },
    {
      name: 'Remove',
      action: NodeMenuItemAction.Remove,
      cssClass: 'remove fa fa-remove'
    },
  ];
