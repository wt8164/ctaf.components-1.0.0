...
export class DomHandler {
    ...
    public addClass(element: any, className: string): void {
        /* tslint:disable */if (element.classList)
    ...
    public index(element: any): number {
        ...
        let num = 0;
     /* tslint:disable */   for (var i = 0; i < children.length; i++) {
       /* tslint:disable */     if (children[i] == element) return num;
      /* tslint:disable */      if (children[i].nodeType == 1) num++;
        }
        return -1;
    }
    ...
    public absolutePosition(element: any, target: any): void {
      ...
      /* tslint:disable */  if (targetOffset.top + targetOuterHeight + elementOuterHeight > viewport.height)
            top = targetOffset.top + windowScrollTop - elementOuterHeight;
      /* tslint:disable */  else
            top = targetOuterHeight + targetOffset.top + windowScrollTop;

       /* tslint:disable */ if (targetOffset.left + targetOuterWidth + elementOuterWidth > viewport.width)
    ...
    public matches(element, selector: string): boolean {
     /* tslint:disable */   var p = Element.prototype;
  /* tslint:disable */      var f = p['matches'] || p.webkitMatchesSelector || p['mozMatchesSelector'] || p.msMatchesSelector || function (s) {
    ...
    public equals(obj1: any, obj2: any): boolean {
        ...
        if (typeof obj1 === 'object' && typeof obj2 === 'object') {
            obj1._$visited = true;
     /* tslint:disable */       for (var p in obj1) {
         /* tslint:disable */       if (p === "_$visited") continue;
                ...
                switch (typeof (obj1[p])) {
                    case 'object':
             /* tslint:disable */           if (obj1[p] && obj1[p]._$visited || !this.equals(obj1[p], obj2[p])) return false;
                        break;

                    case 'function':
           /* tslint:disable */             if (typeof (obj2[p]) === 'undefined' || (p !== 'compare' && obj1[p].toString() !== obj2[p].toString())) return false;
                        break;

                    default:
            /* tslint:disable */            if (obj1[p] !== obj2[p]) return false;
                        break;
                }
            }

       /* tslint:disable */     for (var p in obj2) {
    ...
    isIE() {
 /* tslint:disable */   var ua = window.navigator.userAgent;

 /* tslint:disable */   var msie = ua.indexOf('MSIE ');
    if (msie > 0) {
        // IE 10 or older => return version number
        return true;
    }

  /* tslint:disable */  var trident = ua.indexOf('Trident/');
    if (trident > 0) {
        // IE 11 => return version number
    /* tslint:disable */    var rv = ua.indexOf('rv:');
        return true;
    }

 /* tslint:disable */   var edge = ua.indexOf('Edge/');
    if (edge > 0) {
